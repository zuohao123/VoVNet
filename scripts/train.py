...
def main() -> None:
    ...
    trainer = Trainer(
        ...
        policy_target_mode=cfg.policy.policy_target_mode,
        policy_ce_weight=cfg.policy.policy_ce_weight,
        policy_delta_start=cfg.policy.policy_delta_start,
        policy_delta_end=cfg.policy.policy_delta_end,
        policy_delta_warmup_steps=cfg.policy.policy_delta_warmup_steps,
        policy_delta_no_start=cfg.policy.policy_delta_no_start,
        policy_delta_no_end=cfg.policy.policy_delta_no_end,
        policy_delta_coarse_start=cfg.policy.policy_delta_coarse_start,
        policy_delta_coarse_end=cfg.policy.policy_delta_coarse_end,
        policy_guard_window=cfg.policy.policy_guard_window,
        policy_min_full_ratio=cfg.policy.policy_min_full_ratio,
        policy_min_full_warmup_steps=cfg.policy.policy_min_full_warmup_steps,
        policy_min_coarse_ratio=cfg.policy.policy_min_coarse_ratio,
        policy_min_coarse_warmup_steps=cfg.policy.policy_min_coarse_warmup_steps,
        policy_no_bias_start=cfg.policy.policy_no_bias_start,
        policy_no_bias_end=cfg.policy.policy_no_bias_end,
        policy_no_bias_warmup_steps=cfg.policy.policy_no_bias_warmup_steps,
        policy_open_enable=cfg.policy.policy_open_enable,
        policy_open_quantile=cfg.policy.policy_open_quantile,
        policy_open_margin=cfg.policy.policy_open_margin,
        policy_open_use_best_vis=cfg.policy.policy_open_use_best_vis,
        policy_open_force_visual_warmup_steps=cfg.policy.policy_open_force_visual_warmup_steps,
        policy_open_force_visual_action=cfg.policy.policy_open_force_visual_action,
        policy_open_visual_bias_start=cfg.policy.policy_open_visual_bias_start,
        policy_open_visual_bias_end=cfg.policy.policy_open_visual_bias_end,
        policy_open_visual_bias_warmup_steps=cfg.policy.policy_open_visual_bias_warmup_steps,
        policy_cost_mode=cfg.policy.cost_mode,
        policy_cost_c1=cfg.policy.cost_c1,
        policy_cost_c2=cfg.policy.cost_c2,
        policy_cost_normalize=cfg.policy.cost_normalize,
        policy_enable_soft_targets=cfg.policy.enable_soft_targets,
        policy_soft_target_temperature=cfg.policy.soft_target_temperature,
