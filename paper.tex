...
We use straight-through Gumbel-Softmax with hard one-hot actions:
\begin{equation}
\pi(a\mid x)\approx \mathrm{GS}(\ell(x);\tau),
\end{equation}
where $\mathrm{GS}$ is Gumbel-Softmax with \texttt{hard=True}.
A soft-mixture path exists but is disabled when image-token expansion is required.
...
\begin{table}[t]
  \caption{Main results on MMBench-dev (replace TBD with numbers). N/C/F denotes action ratios; Lat. is latency.}
  \label{tab:main}
  \centering
  ...
  \begin{tabular}{p{0.30\columnwidth}cccc}
    ...
    \midrule
    Always-Full & \textit{TBD} & \textit{TBD} & 0/0/100 & \textit{TBD} \\
    Always-Coarse & \textit{TBD} & \textit{TBD} & 0/100/0 & \textit{TBD} \\
    No-Vision & \textit{TBD} & 0 & 100/0/0 & \textit{TBD} \\
    Threshold (best) & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
    Random Matched & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
    Res. Scaling (best) & \textit{TBD} & \textit{TBD} & 0/0/100 & \textit{TBD} \\
    ...
    \method (ours) & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
    \bottomrule
  \end{tabular}
  }
\end{table}
...
\begin{table}[t]
  \caption{System profiling on MMBench-dev (replace TBD with numbers).}
  \label{tab:profiling}
  \centering
  {\setlength{\tabcolsep}{3pt}\renewcommand{\arraystretch}{1.1}\scriptsize
  \begin{tabular}{p{0.30\columnwidth}cccc}
    ...
    \midrule
    Always-Full & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
    Always-Coarse & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
    \method (ours) & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
    \bottomrule
  \end{tabular}
  }
