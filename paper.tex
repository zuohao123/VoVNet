...
\begin{table}[t]
  \caption{Main results on MMBench-dev (estimated placeholders for layout; replace with full runs). N/C/F denotes action ratios; Lat. is P50 ms.}
  \label{tab:main}
  \centering
...
\cref{tab:generalization} reports accuracy, cost, and action ratios (estimated placeholders).

\begin{table}[t]
  \caption{Cross-benchmark results on MMMU/TextVQA (estimated placeholders; replace with full runs).}
...
\begin{table}[t]
  \caption{Ablations on MMBench-dev (estimated placeholders; replace with full runs).}
  \label{tab:ablation}
  \centering
  {\setlength{\tabcolsep}{3pt}\renewcommand{\arraystretch}{1.1}\scriptsize
...
\begin{table}[t]
  \caption{System profiling on MMBench-dev (estimated placeholders; replace with full runs).}
  \label{tab:profiling}
  \centering
  {\setlength{\tabcolsep}{3pt}\renewcommand{\arraystretch}{1.1}\scriptsize
  \begin{tabular}{p{0.30\columnwidth}cccc}
