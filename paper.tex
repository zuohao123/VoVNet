...
\begin{table}[t]
  ...
  \begin{tabular}{p{0.30\columnwidth}cccc}
    ...
    \midrule
    Always-Full & 0.858 & 5.77 & 0/0/100 & 248 \\
    Always-Coarse & 0.830 & 3.54 & 0/100/0 & 230 \\
    No-Vision & 0.628 & 0.00 & 100/0/0 & 117 \\
    Threshold (best) & 0.818 & 3.10 & 12/45/43 & 238 \\
    Random Matched & 0.760 & 3.00 & 30/35/35 & 235 \\
    Res. Scaling (best) & 0.845 & 3.54 & 0/0/100 & 260 \\
    Token Pruning (best) & 0.842 & 3.00 & 0/0/100 & 268 \\
    Token Merge (best) & 0.836 & 2.60 & 0/0/100 & 275 \\
    Multi-Gran. (best) & 0.844 & 2.70 & 0/0/100 & 270 \\
    \method (ours) & 0.838 & 5.11 & 8/17/75 & 247 \\
    \bottomrule
  \end{tabular}
  }
\end{table}
...
\begin{table}[t]
  ...
  \begin{tabular}{p{0.20\columnwidth}p{0.22\columnwidth}ccc}
    ...
    \midrule
    MMMU & \method & 0.32 & 2.10 & 30/20/50 \\
    MMMU & Always-Full & 0.34 & 4.74 & 0/0/100 \\
    TextVQA & \method & 0.037 & 3.50 & 0/100/0 \\
    TextVQA & Always-Full & 0.038 & 6.94 & 0/0/100 \\
    \bottomrule
  \end{tabular}
  }
\end{table}
...
\begin{table}[t]
  ...
  \begin{tabular}{p{0.38\columnwidth}ccc}
    ...
    $\lambda_{\text{cost}}=0$ & 0.858 & 5.77 & 0/0/100 \\
    \bottomrule
  \end{tabular}
  }
\end{table}
...
\begin{table}[t]
  ...
  \begin{tabular}{p{0.30\columnwidth}cccc}
    ...
    \midrule
    Always-Full & 248 & 274 & 17238 & 314 \\
    Always-Coarse & 230 & 252 & 17075 & 220 \\
    \method (ours) & 247 & 272 & 17180 & 335 \\
    \bottomrule
  \end{tabular}
  }
\end{table}
